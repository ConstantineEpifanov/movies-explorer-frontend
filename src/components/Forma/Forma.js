...
function Form( {welcomeText, submitButtonText, questionText, linkText, link, children}) {
  ...
  return (
    <section className="forma">
      ...
      <Link to="/"><img src={logo} alt="Логотип $" className="forma__logo link-hover" /></Link>
        ...
        <span
          id="forma__error"
          className="forma__error forma__error_visible"
        >
          Что-то пошло не так...
        </span>
